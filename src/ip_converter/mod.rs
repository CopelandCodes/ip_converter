...
impl IpConverter {
    ...
    /// # Arguments
    ///
    /// * `ip` - A string slice containing the decimal IP address (e.g., "192.168.1.1").
    ///
    /// # Returns
    ///
    /// A string containing the hexadecimal representation or an error message.
    ...
    /// # Arguments
    ///
    /// * `ip` - A string slice containing the binary IP address (e.g., "11000000.10101000.00000001.00000001").
    ///
    /// # Returns
    ///
    /// A string containing the decimal representation or an error message.
    ...
    /// # Arguments
    ///
    /// * `ip` - A string slice containing the hexadecimal IP address (e.g., "C0.A8.01.01").
    ///
    /// # Returns
    ///
    /// A string containing the decimal representation or an error message.
